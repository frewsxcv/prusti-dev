...
impl<'l, 'p, 'v, 'tcx> OwnedNonAliasedBuilder<'l, 'p, 'v, 'tcx> {
    ...
    pub(in super::super::super) fn add_field_predicate(
        ...
        let expression = self.inner.lowerer.owned_non_aliased_predicate(
    ...
    pub(in super::super::super) fn add_quantified_permission(
        ...
        let element_predicate_acc = self.inner.lowerer.owned_non_aliased_predicate(
            CallContext::BuiltinMethod,
            element_type,
            element_type,
            element_place,
    ...
    pub(in super::super::super) fn create_variant_predicate(
        ...
        let predicate = self.inner.lowerer.owned_non_aliased_predicate(
            CallContext::BuiltinMethod,
            variant_type,
            variant_type,
            variant_place,
...
//             let root_address = lowerer.pointer_address(ty, base_snapshot, deref.position)?;
//             lowerer.owned_non_aliased_snap(
//                 CallContext::BuiltinMethod,
//                 &deref.ty,
//                 &deref.ty,
...
//                 deref.position,
//             )?
//             // snap_owned_non_aliased$I32(aliased_place_root(), destructor$Snap$ptr$I32$$address(snap_owned_non_aliased$ptr$I32(field_place$$struct$m_T5$$$f$p2(place), root_address)))
